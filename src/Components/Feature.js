    ...
    return (
        <>
            <div className=" container flex justify-center flex-wrap mx-auto my-4">
                <div class="p-2 md:w-1/4 w-full transition ease-in-out delay-100 cursor-pointer hover:-translate-y-1 hover:scale-110  duration-300">
                    <div class="h-full justify-around  flex items-center border-gray-200 border p-4 bg-green-200 shadow-lg">
                        <div className="box">
